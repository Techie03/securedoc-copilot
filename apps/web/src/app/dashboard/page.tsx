...
import LiveLineGraph from '@/components/analytics/LiveLineGraph';
import LiveBarGraph from '@/components/analytics/LiveBarGraph';
import LivePieChart from '@/components/analytics/LivePieChart';
      ...
      <div className="mx-auto max-w-7xl w-full flex-1 flex flex-col">
        ...
        <div className="mt-8 mb-4">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-xl font-bold tracking-tight text-slate-900 dark:text-white">Live System Analytics</h2>
          </div>
