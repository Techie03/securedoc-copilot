      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-white/10 pb-6">
          <div>
            ...
            <p className="text-sm text-slate-400 mt-1">
              Configure, audit, or disable AI semantic memories and user preferences in workspace: <span className="text-cyan-400 font-semibold">{currentWorkspace.name}</span>
            </p>
          </div>
          
          <div className="flex items-center gap-2 rounded-xl bg-emerald-500/10 border border-emerald-500/20 px-3 py-1.5 text-xs text-emerald-400 font-semibold">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="rounded-3xl border border-white/5 bg-slate-900/20 p-6 backdrop-blur-xl space-y-5 relative overflow-hidden shadow-xl">
              ...
              <form onSubmit={handleCreateMemory} className="space-y-4">
                ...
                <div>
                  <label htmlFor="memory-key" className="block text-[10px] font-bold uppercase tracking-wider text-slate-500 mb-1.5">
                  ...
                  <input
                    ...
                    className="block w-full rounded-xl border border-white/5 bg-slate-950/50 py-2.5 px-3.5 text-xs text-white placeholder-slate-500 outline-none ring-1 ring-transparent transition-all duration-300 focus:border-cyan-500 focus:ring-cyan-500/35"
                  />
                </div>

                <div>
                  <label htmlFor="memory-val" className="block text-[10px] font-bold uppercase tracking-wider text-slate-500 mb-1.5">
                  ...
                  <textarea
                    ...
                    className="block w-full rounded-xl border border-white/5 bg-slate-950/50 py-2.5 px-3.5 text-xs text-white placeholder-slate-500 outline-none ring-1 ring-transparent transition-all duration-300 focus:border-cyan-500 focus:ring-cyan-500/35 resize-none"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    >
                      ...
                      <span>Workspace SharedScope</span>
                    </button>
                  </div>
                </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {loading ? (
              <div className="flex flex-col items-center justify-center py-20 space-y-3">
                <Loader2 className="h-8 w-8 animate-spin text-cyan-400" />
                <p className="text-sm text-slate-400">Syncing cognitive profiles...</p>
              </div>
            ) : filteredMemories.length === 0 ? (
              <div className="rounded-3xl border border-white/5 bg-slate-900/10 p-12 text-center backdrop-blur-sm">
                <div className="h-12 w-12 rounded-xl bg-white/5 text-slate-500 flex items-center justify-center mx-auto mb-4">
                  ...
                  {filteredMemories.map((mem) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className="rounded-2xl border border-white/5 bg-slate-900/30 p-4 flex flex-col justify-between backdrop-blur-md relative overflow-hidden group shadow-sm hover:border-white/10 hover:bg-slate-900/40 transition-all duration-300"
                      >
                        ...
                        <div>
                          ...
                          {/* Fact Content */}
                          <p className="text-slate-300 text-xs leading-relaxed font-medium break-words">
                            {mem.memory_value}
                          </p>
                        </div>
                        ...
                        <div className="flex items-center justify-between border-t border-white/5 pt-3 mt-4 text-[10px] text-slate-500">
                          ...
                          <button
                            ...
                            className="p-1.5 rounded-lg bg-transparent hover:bg-rose-500/10 text-slate-500 hover:text-rose-400 transition-colors cursor-pointer"
                            title="Delete Fact"
                          >
